...
function home() {
  root.innerHTML = shell(`<section class="hero"><div class="hero-copy reveal"><span class="eyebrow">BUSINESS STRATEGY FOR AMBITIOUS FOUNDERS</span><h1>Build the business<br><em>before the brand.</em></h1><p class="hero-lead">Brand Blueprint gives you the strategic clarity to make better decisions—before you spend time, money and energy bringing your brand to life.</p><div class="hero-actions"><button class="primary premium-cta" data-start><span>Start Your Blueprint</span><i>↗</i></button><span>Private · founder-led · 12 minutes</span></div></div><aside class="hero-principle reveal"><span class="principle-number">01</span><p>A beautiful identity cannot rescue an unclear business.</p><div><span class="portrait">DB</span><span><strong>Daniel Band</strong><small>Founder & commercial strategist</small></span></div></aside></section>
  ...
  <section class="about"><div class="about-label reveal"><span class="eyebrow">ABOUT DANIEL</span><span class="portrait portrait-large">DB</span></div><div class="about-story reveal"><h2>I’m not here to sell you a rebrand. I’m here to help you build a stronger business.</h2><div class="about-columns"><p>I’m Daniel Band. I’ve spent my career building businesses, shaping propositions and turning ideas into commercial opportunities. That means working in the decisions founders actually face—not observing them from the outside.</p><p>Brand Blueprint distils that experience into a practical way to think. No agency theatre. No borrowed playbook. Just honest questions, commercial perspective and a clear route forward.</p></div><span class="signature">Daniel Band</span></div></section>
  <section class="blueprint"><div class="blueprint-intro reveal"><span class="eyebrow">THE BRAND BLUEPRINT</span><h2>Three disciplines.<br>One coherent business.</h2><p>A brand is not a layer added at the end. It is the connection between what you believe, what you build and how you grow.</p></div><div class="blueprint-steps">
    <article class="reveal"><span>01</span><div><small>THINK</small><h3>Find the truth worth building around.</h3><p>Clarify the opportunity, customer, position and commercial logic. Decide what the business stands for—and what it will not be.</p></div></article>
    <article class="reveal"><span>02</span><div><small>IMPLEMENT</small><h3>Turn strategy into something real.</h3><p>Translate clear thinking into your name, message, offer, identity and customer experience so every choice works together.</p></div></article>
    <article class="reveal"><span>03</span><div><small>GROW</small><h3>Build momentum with intent.</h3><p>Use the brand to guide sales, partnerships, licensing and negotiation—creating value without losing what made the business matter.</p></div></article>
  </div></section>
  <section class="experience"><div class="experience-heading reveal"><span class="eyebrow">FOUNDER EXPERIENCE</span><h2>Advice shaped by doing,<br>not just advising.</h2><p>My perspective comes from the practical work of moving businesses forward: finding the opportunity, making the case and getting the deal done.</p></div><div class="experience-list reveal"><span>Building businesses</span><span>Commercialisation</span><span>Licensing</span><span>Negotiation</span><span>Naming</span><span>Domain strategy</span><span>Brand strategy</span></div></section>
  <section class="final-cta"><div class="reveal"><span class="eyebrow">YOUR NEXT MOVE</span><h2>See your business<br>more clearly.</h2><p>Answer the questions I would ask if we were sitting across the table. You’ll uncover what is working, what is missing and where to focus next.</p><button class="primary premium-cta light" data-start><span>Start Your Blueprint</span><i>↗</i></button><small>Five focused workshops · approximately 12 minutes</small></div></section>`)
  bindHome()
}
